 ...
 * 
 * Note: This file is duplicated from ws/ws-client.ts
 * If ws/ws-client.ts is modified, sync both versions manually
 * 
 * Features:
 ...
 * 
 * Changes:
 * - 2025-11-03: Copied to react/src/lib/ for browser deployment
 * - 2025-11-03: Updated to use eventemitter3 for Node.js + browser compatibility
