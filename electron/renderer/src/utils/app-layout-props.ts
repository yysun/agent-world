...
export function createMainContentRightPanelContentProps<T extends PropBag>(input: T) {
  return {
    ...
    onOpenWorldTextEditor: input.onOpenWorldTextEditor,
    ...
    onOpenAgentPromptEditor: input.onOpenAgentPromptEditor,
...
export function createLeftSidebarProps<T extends PropBag>(input: T) {
  return {
    ...
    appUpdateState: input.appUpdateState,
    onCheckForUpdates: input.onCheckForUpdates,
    onInstallUpdateAndRestart: input.onInstallUpdateAndRestart,
