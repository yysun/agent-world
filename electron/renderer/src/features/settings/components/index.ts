 ...
 *
 * Key Features:
 * - Groups settings row widgets and settings panel content.
 ...
 *
 * Recent Changes:
 * - 2026-04-19: Added the settings panel content export for shell routing.
 * - 2026-03-23: Added the initial feature-scoped settings components barrel.
 */

export { default as SettingsPanelContent } from './SettingsPanelContent';
