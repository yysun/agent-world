 ...
 *
 * Recent Changes:
 * - 2026-02-25: Added dedicated GitHub world-import module loader for Electron IPC dependency injection parity with other core functions.
...
export async function importCoreGitHubWorldImportModule(baseDir: string): Promise<any> {
  const candidates = [
    path.resolve(baseDir, '../../dist/core/storage/github-world-import.js'),
    path.resolve(baseDir, '../dist/core/storage/github-world-import.js')
  ];
