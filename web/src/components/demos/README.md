...
AGENT_WORLD_STORAGE_TYPE=file npx tsx scripts/migrate-storage.ts "The Infinite Etude" replace
```
...
AGENT_WORLD_STORAGE_TYPE=sqlite npx tsx scripts/migrate-storage.ts "The Infinite Etude" replace
```
