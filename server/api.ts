 ...
 * - Optimized world existence checks to use getWorldConfig for lightweight access and getWorld for full operations
...
async function getWorldOrError(res: Response, worldName: string): Promise<World | null> {
