...
vi.mock('../../packages/llm/src/runtime.js', () => ({
  generate: mockGenerate,
  stream: mockStream,
}));

import { runTurnLoop } from '../../packages/llm/src/turn-loop.js';
import type { LLMChatMessage, LLMResponse } from '../../packages/llm/src/types.js';
