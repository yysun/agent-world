/**
 * Message Store - Global Conversation Memory System
 * 
 * Features:
 ...
 * - Memory-efficient storage with optional message retention limits
 * 
 * Implementation:
 ...
 * - Configurable retention policies for long-running sessions
 * 
 * Usage:
 * - Call addMessageToStore() from all message sources
 * - Use getMessagesForWorld() for export and display operations
...
export interface StoredMessage {
  ...
  worldName: string;
  metadata?: {
    source?: 'cli' | 'agent' | 'system' | 'streaming';
...
// Global message storage - Map of worldName -> messages array
...
/**
 * Add a message to the global store
 */
