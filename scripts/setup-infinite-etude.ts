...
Example Output: "I have composed a C Major scale in 4/4 time. It consists of the notes C4, D4, E4, F4, G4, A4, B4, C5, all as quarter notes."

CRITICAL RULE:
You MUST end your response by explicitly tagging the next agent: "@Madame Pedagogue".
If you do not tag her, the workflow will break.
DO NOT sign your own name.`
    ...
    await createAgentSafe({
        ...
        temperature: 0.4,
        maxTokens: 2048,
        systemPrompt: `You are Madame Pedagogue. Your role is to validate the music for the "The Infinite Étude".
...
4. You MUST end your response by commanding: "@Monsieur Engraver please render this."`
    });
